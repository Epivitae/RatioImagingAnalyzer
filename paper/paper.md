...
3.  **Enhances Efficiency**: Utilizing vectorized operations from `NumPy` [@Harris:2020] and the C++ backend of `OpenCV` [@Bradski:2000], RIA processes large datasets instantly, ensuring the smooth operation of the softwave, and enabling rapid tests of hypothesis.
# Implementation
